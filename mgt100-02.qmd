...
![](images/pinktax.png){fig-align="center" height="400px"}
...
::: {.callout-note appearance="minimal" style="font-size: 1.1em;"}
...
3. How do I choose the # of principal components?
    - Business criteria: Usually 1 or 2 if you mainly want to visualize the data. If more, consider actionability of compressed data
...
![](images/embed2.png){fig-align="center" height="200px"}
...
- Download the class survey data HERE
