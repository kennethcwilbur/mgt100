...
-   [Einav et al.
    (2021)](https://www.nber.org/system/files/working_papers/w29561/w29561.pdf){target="_blank"} 
...
![](images/dray4b.png){fig-align="center" fig-width="5in"}

::: aside
Dray has a powerful predictive analytics engine between his ears
:::
...
-   3 ways to estimate:
    -   "Top Down" Total Addressable Market (TAM) : <br>How many people
        have the core need?
    -   "Bottom up" Served Available Market (SAM): <br>How many people currently
...
-   Let's check [Grand View
    Research](https://www.grandviewresearch.com/industry-analysis/mattress-market){target="_blank"} 
    &
    [ISPA](https://sleepproducts.org/resources/statistics/industry-sales-data/){target="_blank"} 
...
![](images/diffusion_curve.png){fig-align="center" width="6.5in"}

::: aside
- Blue is PDF (adoptions), Yellow is CDF (cume adoptions)
- We often equate adoptions and sales early in a product lifecycle
:::
...
![](images/newproducts.png){fig-align="center" width="8in"}
...
::: aside
More: [Kickstarter](https://www.kickstarter.com/){target="_blank"}, [Product Hunt](https://www.producthunt.com/){target="_blank"}, [Gizmodo](https://gizmodo.com/){target="_blank"} 
:::
...
::: aside
[Source](https://web.archive.org/web/20240516070323/https://www.theverge.com/24134914/discord-ceo-gaming-chat-teens-safety-moderation-decoder-interview){target="_blank"} 
:::
...
::: aside
- [A 2012 introduction and demonstration by Google's chief economist](https://drive.google.com/file/d/18aecUVA9gxUTuaItl4i-ceB9sDxVAhb1/view?usp=drive_link){target="_blank"} 
- Or see a [more recent analysis](https://drive.google.com/file/d/18iNUBfw55raGFLOfMC-H6n55OvdToY0G/view?usp=drive_link){target="_blank"} 
:::
...
::: aside
- [Source](https://web.archive.org/web/20240330030348/https://www.newyorker.com/magazine/2014/09/22/home-free){target="_blank"} 
:::
...
- So, operators block and limit frequent winners. Pros use "beards." More [here](https://archive.ph/LERIB){target="_blank"} & [here](https://archive.ph/4dDzB){target="_blank"}
:::
...
- Assume price is \$100, margin \$50, retention 50%, <br>discount rate 10%, horizon T=1 
...
::: aside
More [here](https://archive.ph/O6Wv0){target="_blank"} or [here](https://drive.google.com/file/d/15njIpqcSy99e4l04kAfhDvvDjgIirkRo/view?usp=drive_link){target="_blank"}
:::
...
-   [Innovation Diffusion and New Product Growth Models (Peres et al.
    2009)](https://www.sciencedirect.com/science/article/pii/S0167811610000236){target="_blank"} 

-   [Customer-Base Valuation in a Contractual Setting with Heterogeneity
    (Fader & Hardie
    2010)](https://drive.google.com/file/d/14zg5gPEOqlqp_JZ_bRmewCsqOmoOBKdH/view?usp=drive_link){target="_blank"} 

-   [Exploring the Distribution of Customer Lifetime Value (Fader &
    Hardie
    2017)](https://drive.google.com/file/d/150sD29FpyzpQ9B0WL5kHwJdrwpp9bf_S/view?usp=drive_link){target="_blank"} 

-   [Firing your best customers (Avery & Fournier
    2012)](https://drive.google.com/file/d/15Ix93FCBM8JPqLPcUcIlL_2sxHRedVqs/view?usp=drive_link){target="_blank"} 
