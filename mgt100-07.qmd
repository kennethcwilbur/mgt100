...
![](images/brandformance.png){fig-align=center width=9in}

::: aside
Brand and performance campaigns compete for budget. [More](https://www.silverbackstrategies.com/blog/brand-vs-performance-marketing/){target="_blank"}; [Example](https://www.youtube.com/watch?v=or4P0p_ojkM){target="_blank"}
:::


## Brand is Dead?

![](images/brand_is_dead.png){fig-align=center width=9.5in}

::: aside
We've been hearing takes like this for generations
:::

## 

![](images/programmatic.webp){fig-align=center width=9.5in}

::: aside
[IAB Glossary](https://www.iab.com/insights/glossary-of-terminology/){target="_blank"} defines *Programmatic* as "using technology to automate and optimize...the ad buying process" [more here](https://fastercapital.com/content/Programmatic-Advertising--How-to-Use-Programmatic-Advertising-to-Automate-and-Optimize-Your-Advertising-Funnel.html){target="_blank"}
:::

## 
 
![](images/prog_pros.png){fig-align=center width=6in}

::: aside
[2024 data source](https://www.iab.com/insights/internet-advertising-revenue-report-full-year-2024/){target="_blank"}
:::

## 

![](images/zuck1.png){fig-align=center width=8.5in}

::: aside
- [source](https://www.theverge.com/meta/659506/mark-zuckerberg-ai-facebook-ads)
:::
...
![](images/display_lumascape.png){fig-align=center width=9.5in}

::: aside
[source](https://lumapartners.com/lumascapes/){target="_blank"}
:::

## 

![](images/airbnb1.png){fig-align=center width=9.5in}

::: aside
[source](https://www.gotracksuit.com/blog/posts/how-airbnb-proves-the-power-of-brand){target="_blank"}
:::

## 

![](images/airbnb2.avif){fig-align=center width=9.5in}

## 

![](images/airbnb3.png){fig-align=center width=9.5in}
