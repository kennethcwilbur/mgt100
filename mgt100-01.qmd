...
::: {.callout-note appearance="minimal"}
800 e-commerce pros were surveyed; companies using 9+ data-driven methods were most satisfied with their conversion rates. The optimal number of A/B tests was 3-5 per month.<br>This model is also known as the purchase journey. How does it facilitate decisionmaking?
:::
...
## How I use and don't use LLMs {.smaller}
