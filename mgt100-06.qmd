...
![](images/camel3stepladder.png){fig-align="center" width=5.9in}

::: aside
[source](https://camelcamelcamel.com/product/B087279HM1?tp=all&cpf=amazon-new-used){target="_blank"}. See also PriceSpy, SmartScout; but not Honey or Keepa
:::
...
- Authors observe listings by date and can estimate the listing ordering algorithm
- However, authors do not observe individual user search results, so findings estimate a model of how search results appeared to customers


## Model estimates indicate
