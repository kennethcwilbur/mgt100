...
## Brand Safety, Content Moderation {.scrollable .smaller}

- Brands prefer to avoid unsavory associations <br>(misinfo, hate, violence, obscenity, ...), so they demand advertising platforms maintain "brand safety" 

![](images/x_adrevenuechanges.png){fig-align="center" width=8in}
...
![](images/bron15a.png){fig-align=center width=9in}
...
![](images/bron15b.png){fig-align=center width=9in}
...
- Best practice: Match brand personality to 
    ...
    - target customer's preferences or aspirations 

## 4. Gestalt

![](images/peanutbutter.png){fig-align=center width=9in}
...
- See paper by Neuroscientists in Baylor, Houston ... McClure et al. ... “Neural Correlates of Behavioral Preferences for Culturally Familiar Drinks” in the Neuron, Vol 44
:::
