...
- Firm strategies lie between two extremes:
  ...
  1. Promote well: High CAC, high acquisition, high churn
...
![](images/customer_matrix.png){fig-align=center width=7in}
...
![](images/instacart_gov.png){fig-align=center width=9in}
...
![](images/doordash_gov.png){fig-align=center width=9in}
...
![](images/shipt_revenue.png){fig-align=center width=9in}
...
- Modeling is a superpower!
          ...
          - Modeling skills develops with practice & transfer across domains
          
- Cautions

          - Simple models are usually 85-95% effective
          - There is never a true model
          - Never mistake the model for the phenomena
          - "Model uncertainty" is always present
          - It's not "your" model
          - Beware modeling for the sake of modeling 
