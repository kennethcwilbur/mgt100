...
::: {.callout-note appearance="minimal" style="font-size: 0.85em; margin-top: 3px;"}
...
- If you only summarize with regression, you might miss something important
...
- Catalogue retailers were the OGs -E-commerce more recently - talk about how to measure each of these Talk about drop-offs from each level to the next -Talk about easy ways to turn drop-offs into actions -These are examples of descriptive & diagnostic analytics
:::
