...
::: {.callout-note appearance="minimal"}
How might competitors, distribution partners, or suppliers react to price variation?<br><br>Why might combining experiments with demand modeling be better than either alone?
:::
...
- He organized a team that collected pre-BART transportation choices by commuters in neighborhoods that were to receive BART stations. Product attributes included things like walking distance, waiting time, financial cost, and automotive preference dummy
...
- By definition, a demand model is a causal price-quantity relationship <br>
...
- Your standard advice to a firm would be to induce non-obvious experimental variation when possible in order to estimate price responsiveness, such as price variation across markets or targeted coupons
