...
::: aside
Eg. ["Triangle retention chart"](https://articles.sequoiacap.com/retention){target="_blank"}
:::
...
::: notes
- Modeling details treated by ![McCarthy and Fader (2018)](https://journals.sagepub.com/doi/pdf/10.1177/0022243718802843){target="_blank"}
:::
...
::: notes 
- [Source: WSJ on Blue Apron Financials, pre-IPO](https://web.archive.org/web/20201112043423/https://www.wsj.com/articles/stir-fry-on-sale-blue-apron-turns-to-deals-to-draw-customers-1498561202){target="_blank"}
...
- [Source: Motley Fool in 2019    ](https://web.archive.org/web/20210228221306/https://www.fool.com/investing/2019/03/28/lyfts-ipo-the-one-article-you-need-to-read.aspx){target="_blank"}
::: 
...
- [Source: McCarthy (2021)     ](https://www.linkedin.com/pulse/doordash-instacart-shipt-tale-3-covid-bumps-daniel-mccarthy/){target="_blank"}
::: 
...
- Each team starts with 3 assets and $20 million cash
...
1. State a selling price: "Team (w) ASKS $a.bc" or "WANTS TO SELL AT $a.bc"
2. State a buying offer: "Team (x) BIDS $d.ef" or "Team (x) WANTS TO BUY at $d.ef" 
3. Accept a selling price: "Team (y) ACCEPTS Team (w)'s ask"
4. Accept a buying offer: "Team (z) ACCEPTS Team (x)'s bid" 

Rules:

- Max 1 (ASK or BID) per team per round

    - No limit on ACCEPTs

- No BID < highest open bid or ASK > lowest open ask
- Smallest increment: \$0.50
- You can only bid/accept if you have the asset or cash to cover
- We track all trades; you track your own assets, payouts and cash by round
    - [Open this google sheet](https://docs.google.com/spreadsheets/d/1WRXSRIrywx1cn-V5UPSngYRpUf8GsqX_5a2cKMTuuz8/view){target="_blank"}; let's walk through it
- Raise your hand to ask/bid/accept ; be ready to speak
...
::: notes
- Takeaway 1: Most people don't bother to calculate fair value. Even with strong incentives and full information. Therefore, the market price easily may depart from economic fundamentals. This happens frequently in asset markets. The efficient markets hypothesis is only a hypothesis; it is valuable, but you should absolutely not assume that it always holds. If you do calculate fair value, you have a massive advantage in trading markets. If you do not calculate fair value, you have a massive disadvantage relative to those who do calculate fair value. 
- Takeaway 2: What people do clearly see is how prices are changing. It's not unusual for people to notice a trend of rising asset prices, then extrapolate from that trend to predict continually rising asset prices. About 85-90% of the time this classroom experiment is run, an asset price bubble develops through the first 4-5 rounds, and then pops at the end. Asset price bubbles have happened many many times throughout history, including in real estate, cryptocurrency, NFTs and elsewhere. The amazing thing about asset price bubbles, from the perspective of those who know the fair value, is that you cannot predict when they will pop. Because the more they inflate, the more data there is to strengthen noise traders' extrapolations of continually rising prices.  
:::
...
- [Customer-Based Corporate Valuation for Publicly Traded Noncontractual Firms](https://drive.google.com/file/d/1KGGaNdf2m7yx0wxZhZAspoNLA93jYNLh/view?usp=drive_link){target="_blank"}
