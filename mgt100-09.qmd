...
-   CLV models are typically misspecified & uncertain
        ...
        - Main drawback: Contains no customer purchase model
...
-   Guiding Principles
        ...
        - The firm and the customer have opposing interests in price. Using CLV for margin extraction harms the model's predictive validity, and may generate perverse customer incentives 
