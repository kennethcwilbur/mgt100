...
## Today we'll use theory to pick 2 segmentation attributes
...
# Note: this is really common. It's often done so that regression parameters are expressed 
# as standard deviations and therefore become more comparable to each other
...
# run this function a few times to show convergence
...
ggplot(data.frame(x = 1:10, y = res), aes(x, y)) +
  ...
  theme_minimal()
# this is sometimes called an "elbow graph"
